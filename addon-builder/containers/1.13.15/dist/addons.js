...
define('ember-cli-selectize/components/ember-selectize', ['exports', 'ember', 'ember-new-computed'], function (exports, _ember, _emberNewComputed) {
  ...
  exports['default'] = _ember['default'].Component.extend({
    ...
    */
    ...
    _optgroupsDidChange: _ember['default'].observer('optgroups.[]', function () {
      var _this3 = this;
    ...
    */
    ...
    selectizeOptions: computed(function () {
      ...
      var options = {
        ...
        searchField: 'label',
        optgroupField: 'optgroup',
        create: allowCreate ? _ember['default'].run.bind(this, '_create') : false,
        onItemAdd: _ember['default'].run.bind(this, '_onItemAdd'),
        onItemRemove: _ember['default'].run.bind(this, '_onItemRemove'),
        onType: _ember['default'].run.bind(this, '_onType'),
      ...
      var generalOptions = ['delimiter', 'diacritics', 'createOnBlur', 'createFilter', 'highlight', 'persist', 'openOnFocus', 'maxOptions', 'maxItems', 'hideSelected', 'closeAfterSelect', 'allowEmptyOption', 'scrollDuration', 'loadThrottle', 'preload', 'dropdownParent', 'addPrecedence', 'selectOnTab'];
    ...
    didInsertElement: function didInsertElement() {
      ...
      _ember['default'].assert('selectize has to be loaded', typeof this.$().selectize === 'function');
    ...
    */
    ...
    _addSelection: function _addSelection(obj) {
      ...
      var val = _ember['default'].get(obj, _valuePath);
    ...
    */
    _selectionDidChange: _ember['default'].observer('selection', function () {
      var _this5 = this;
      ...
      if (selection) {
        if (multiple) {
          _ember['default'].assert('When ember-selectize is in multiple mode, the provided selection must be an array.', isArray(selection));
          ...
          if (selection.then) {
            selection.then(function (resolved) {
              if (resolved) {
                ...
                if (get(_this5, 'selection') === selection) {
                  _this5._selectize.addItem(get(resolved, _this5.get('_valuePath')));
                }
              }
            });
          } else {
    ...
    */
    _contentDidChange: _ember['default'].observer('content', function () {
      var _this6 = this;
      ...
      if (isArray(content)) {
        ...
        content.then(function (resolved) {
          // Ensure that we don't overwrite new value
          if (get(_this6, 'content') === content) {
            _this6.set('content', resolved);
          }
        });
      }
      var len = content ? get(content, 'length') : 0;
    ...
    */
    ...
    _groupedContentWillChange: function _groupedContentWillChange(groupedContent) {
      ...
      if (_ember['default'].isEmpty(groupedContent)) {
        return;
      }

      groupedContent.forEach(function (group) {
        group.get('content').removeArrayObserver(_this7, {
    ...
    */
    _groupedContentDidChange: _ember['default'].observer('groupedContent', function () {
      var _this8 = this;
      ...
      groupedContent.forEach(function (group) {
        group.get('content').addArrayObserver(_this8, {
          willChange: '_groupedContentArrayWillChange',
          didChange: '_groupedContentArrayDidChange'
        });
      });
    ...
    * Here we process the removed elements
    */
    _groupedContentArrayWillChange: _ember['default'].K,
    ...
    */
    _disabledDidChange: _ember['default'].observer('disabled', function () {
      if (!this._selectize) {
        return;
      }
    ...
    */
    _placeholderDidChange: _ember['default'].observer('placeholder', function () {
      if (!this._selectize) {
        return;
      }
    ...
    */
    _loadingDidChange: _ember['default'].observer('loading', function () {
    ...
    _componentToDOM: function _componentToDOM(componentName, data) {
      ...
      var ComponentClass = componentLookup.lookupFactory(componentName);

      if (!ComponentClass) {
        throw new TypeError('component ' + componentName + ' does not exist.');
      }

      var component = ComponentClass.create({
        data: data
      });
    ...
    _mergeSortField: function _mergeSortField(options) {
      ...
      if (sortField) {
        ...
        _ember['default'].merge(options, { sortField: sortArray });
      }
      return options;
    },
...
define('ember-cli-selectize', ['ember-cli-selectize/index', 'ember', 'exports'], function(__index__, __Ember__, __exports__) {
  'use strict';
...
define('demo-app/components/ember-selectize', ['exports', 'ember-cli-selectize/components/ember-selectize'], function (exports, _emberCliSelectizeComponentsEmberSelectize) {
